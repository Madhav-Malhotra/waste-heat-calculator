...
float TEST_weight_container[] = {0.010, 0.999, 1.00001, 55.0, 750.0, 1293.0};
float TEST_weight_water_container[] = {0.010, 0.011, 0.999, 1.00001, 55.0, 750.0, 1293.0, 1293.1};
...
float TEST_initial_cost[] = {0.0001, 0.12, 0.9999, 2.231, 15.23, 100.12, 12000.1};
float TEST_annual_savings[] = {0.0001, 0.12, 0.9999, 2.231, 15.23, 100.12, 12000.1};